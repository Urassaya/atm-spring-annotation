...
@Autowired
    ...
    public String validateCustomer(int id,int pin) {
        ...
        //ถ้า id ตรงจะตรวจสอบ pinของลูกค้าว่าตรงกับที่เก็บไว้หรือไม่
    ...
    //delegation
    public void deposit(double amount){ loginCustomer.getAccount().deposit(amount); }
    public void withdraw(double amount){ loginCustomer.getAccount().withdraw(amount); }

    public double getBalance(){ return loginCustomer.getAccount().getBalance(); }
    ...
    public void end(){ loginCustomer = null; }
}
